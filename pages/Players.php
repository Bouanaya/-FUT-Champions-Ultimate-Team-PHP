 ...
 <body class="relative">
  ...
  <div class="form h-full  w-full flex justify-center hidden  ">
  <form class="card w-full bg-slate-800 p-2  " id="form">
        <h1 class="text-white  md:text-3xl ">ENTER INFO</h1>
          ...
          >
            submit
                         ...
                         <div class="tables absolute  hidden w-full z-0  h-full">
